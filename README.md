# (Unofficial) eBay API client (PHP) - Buy / Order
...
Please refer to [eBay's documentation](https://developer.ebay.com/api-docs/buy/order/overview.html) for detailed API 
...
Starting from version v2.0.0, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/buy/order/v2/',
        'headers'=>[
